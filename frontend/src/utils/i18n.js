...
const resources = {
  en: {
    translation: {
      ...
      'location.2.name': 'Albany Branch',
      'location.2.address': 'Unit 4B, 14 Corinthian Drive, Albany Auckland',
      'location.2.hours': 'Mon-Sat: 9AM-7PM',
      'location.3.name': 'Dominion Road Branch',
      'location.3.address': '579 Dominion Road, Balmoral',
      'location.3.hours': 'Mon-Sat: 9AM-7PM',
      'location.4.name': 'Newmarket Branch',
      'location.4.address': '38 Remuera Road, Newmarket',
